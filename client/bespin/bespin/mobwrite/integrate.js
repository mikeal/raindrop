...
if(!dojo._hasResource["bespin.mobwrite.integrate"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["bespin.mobwrite.integrate"] = true;
