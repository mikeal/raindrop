...
function (rd, dojo, Conversation, wiper) {
     ...
     */
    return dojo.declare("rdw.ext.mailingList.Group", [Conversation, wiper], {
        ...
        addConversation: function (conversation) {
            ...
            var convoId = conversation.id, msg, listDoc;
            if (convoId && !this.convoIds[convoId]) {
                ...
                listDoc = conversation.messages[0].schemas["rd.msg.email.mailing-list"];
        ...
        display: function () {
            ...
            //Update total count.
            rd.escapeHtml(rd.template(this.i18n.poundCount, {
